...
const dom = (() => {
  ...
  function getMoon(moonPhase) {
    ...
    if (moonPhase === 0 || moonPhase === 1) {
      moonName = 'New Moon';
      moonIcon = './src/dist/moon-new.svg'; // Correct path for New Moon SVG
    }
    if (moonPhase === 0.25) {
      moonName = 'First Quarter Moon';
      moonIcon = './src/dist/assets/moon-first-quarter.svg'; // Correct path for First Quarter Moon SVG
    }
    if (moonPhase === 0.5) {
      moonName = 'Full Moon';
      moonIcon = './src/dist/assets/moon-full.svg'; // Correct path for Full Moon SVG
    }
    if (moonPhase === 0.75) {
      moonName = 'Last Quarter Moon';
      moonIcon = './src/dist/assets/moon-last-quarter.svg'; // Correct path for Last Quarter Moon SVG
    }
    if (moonPhase > 0 && moonPhase < 0.25) {
      moonName = 'Waxing Crescent';
      moonIcon = './src/dist/assets/moon-waxing-crescent.svg'; // Correct path for Waxing Crescent Moon SVG
    }
    // ... (similarly for other moon phases)
